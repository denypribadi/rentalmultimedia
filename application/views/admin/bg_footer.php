 <!-- Footer Start -->
            <footer>
                Company Profile &copy; 2015 By Jerapah Developer.
	...
	<script src="<?php echo base_url('Ultraviolet_GUI/Admin/assets/libs/prettify/prettify.js');?>"></script>
	<script src="<?php echo base_url('Ultraviolet_GUI/Admin/assets/js/init.js');?>"></script>
	<script src="<?php echo base_url('Ultraviolet_GUI/Admin/assets/libs/summernote/summernote.js');?>"></script>
	<script src="<?php echo base_url('Ultraviolet_GUI/Admin/assets/js/pages/forms.js');?>"></script>
	<script src="<?php echo base_url('Ultraviolet_GUI/Admin/assets/libs/jquery-datatables/js/jquery.dataTables.min.js');?>"></script>
	<script src="<?php echo base_url('Ultraviolet_GUI/Admin/assets/libs/jquery-datatables/js/dataTables.bootstrap.js');?>"></script>
	<script src="<?php echo base_url('Ultraviolet_GUI/Admin/assets/libs/jquery-datatables/extensions/TableTools/js/dataTables.tableTools.min.js');?>"></script>
	<script src="<?php echo base_url('Ultraviolet_GUI/Admin/assets/js/pages/datatables.js');?>"></script>
	</body>
